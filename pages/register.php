                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select id="grade_level" name="grade_level" required
                                                class="w-full px-4 py-3 text-xs border border-gray-300 rounded-xl input-focus focus:border-[#800000] focus:ring-2 focus:ring-[#800000]/20 outline-none">
                                                <option class="text-[10px]" value="">Select Grade Level</option>
                                                <option class="text-[10px]" value="7">Grade 7</option>
                                                <option class="text-[10px]" value="8">Grade 8</option>
                                                <option class="text-[10px]" value="9">Grade 9</option>
                                                <option class="text-[10px]" value="10">Grade 10</option>
                                                <option class="text-[10px]" value="11">Grade 11</option>
                                                <option class="text-[10px]" value="12">Grade 12</option>
                                            </select>
                                        </div>
