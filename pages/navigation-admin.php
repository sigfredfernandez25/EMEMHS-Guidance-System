...
<div class="fixed inset-y-0 left-0 bg-white shadow-lg transform transition-all duration-300 ease-in-out z-50" id="sidebar">
    ...
    <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200 sidebar-header">
        <div class="flex items-center space-x-2 sidebar-logo">
            <img src="../image/ememhs-logo.png" alt="EMEMHS Logo" class="sidebar-logo-img h-10 w-auto max-w-[40px]">
            <span class="text-sm font-bold text-[#800000] whitespace-nowrap sidebar-logo-text">EMEMHS Guidance</span>
        </div>
        <div class="flex items-center space-x-2 sidebar-toggle">
            ...
            <button class="lg:hidden text-gray-500 hover:text-gray-700 focus:outline-none" id="closeSidebar" title="Close Menu">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex flex-col h-[calc(100vh-4rem)] overflow-hidden">
        <div class="flex-1 px-4 py-2 overflow-y-auto space-y-1" style="scrollbar-width: thin; scrollbar-color: #800000 #f1f1f1;">
        <?php if ($isLoggedIn): ?>
            <a href="staff-dashboard.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'staff-dashboard.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Dashboard">
            ...
            <a href="scheduled-complaints.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'scheduled-complaints.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Scheduled Complaints">
                <span class="icon-center relative">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="reschedule-requests-admin.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'reschedule-requests-admin.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Reschedule Requests">
                <span class="icon-center relative">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="unresolved-issues.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'unresolved-issues.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Unresolved Issues">
                <span class="icon-center relative">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="all-complaints.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'all-complaints.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="All Complaints">
                <span class="icon-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="record-walkin-complaint.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'record-walkin-complaint.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Record Walk-in">
                <span class="icon-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Student Management -->
            <a href="students-list.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'students-list.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Students">
                <span class="icon-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="student-verification.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'student-verification.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Student Verification">
                <span class="icon-center relative">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Other Services -->
            <a href="admin-lost-items.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'admin-lost-items.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Lost Items">
                <span class="icon-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="admin-suggestions.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'admin-suggestions.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Suggestions">
                <span class="icon-center relative">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="notifications.php" class="nav-link flex items-center space-x-3 px-4 py-1.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'notifications.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Notifications">
                <span class="icon-center relative">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            link.addEventListener('mouseenter', function(e) {
                if (sidebar.classList.contains('collapsed')) {
                    ...
                    if (tooltip) {
                        ...
                        const tooltipHeight = tooltip.offsetHeight || 30; // Approximate height
                        const centerPosition = rect.top + (rect.height / 2) - (tooltipHeight / 2);
                        tooltip.style.top = centerPosition + 'px';
                    }
                }
            });
        });
