...
<div class="fixed inset-y-0 left-0 bg-white shadow-lg transform transition-all duration-300 ease-in-out z-50" id="sidebar">
    ...
    <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200 sidebar-header">
        <div class="flex items-center space-x-2 sidebar-logo">
            <img src="../image/ememhs-logo.png" alt="EMEMHS Logo" class="sidebar-logo-img h-10 w-auto max-w-[40px] mx-auto">
    ...
    <!-- Navigation Links -->
    <div class="px-4 py-5 space-y-1.5 overflow-y-auto h-[calc(100vh-4rem)]">
        <?php if ($isLoggedIn): ?>
            <a href="staff-dashboard.php" class="nav-link flex items-center space-x-3 px-4 py-2.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'staff-dashboard.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Dashboard">
            ...
            <a href="notifications.php" class="nav-link flex items-center space-x-3 px-4 py-2.5 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#800000] text-sm <?php echo ($current_page == 'notifications.php') ? 'bg-[#800000]/10 text-[#800000] font-medium' : 'text-gray-700 hover:text-[#800000] hover:bg-gray-50'; ?>" tabindex="0" data-tooltip="Notifications">
                <span class="icon-center relative">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
